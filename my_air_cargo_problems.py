...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        pos = set(fluent_state.pos)
        neg = set(fluent_state.neg)

        def is_action_applicable(action):
            return action.precond_pos.issubset(pos) and action.precond_neg.issubset(neg)

        possible_actions = [a for a in self.actions_list if is_action_applicable(a)]
